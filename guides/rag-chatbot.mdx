...
**Specimen terms** (`SPECIMEN_QUESTION_TERMS`): `este espécimen`, `este ejemplar`, `ejemplar`, `pieza`, `pieza expuesta`, `pieza exhibida`, `expuesto`, `exhibido`, `museo`, `vitrina`, `colección`, `sala`, `procedencia`, `origen`, `de dónde viene`, `donde fue encontrado`, `hallado`, `recolectado`, `colectado`, `capturado`, `donado`, `ingresó al museo`, `registro`, `inventario`, `catalogado`, `localidad`, `sitio`

**General terms** (`GENERAL_QUESTION_TERMS`): `hábitat`, `habitat`, `dieta`, `qué come`, `come`, `distribución`, `dónde vive`, `vive`, `familia`, `orden`, `reproducción`, `longevidad`, `mide`, `peso`, `envergadura`, `características`, `ecología`, `comportamiento`, `estado de conservación`, `amenazas`, `curiosidades`
