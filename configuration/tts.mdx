---
title: "Configure the BioScan TTS Voice Service"
sidebarTitle: "TTS Settings"
description: "Configure BioScan Museo's Edge TTS sidecar: select voice, speech rate, volume, audio cache directory, and integrate it with the Flask app via shared keys."
---
...
| Variable | Type | Default | Description |
|---|---|---|---|
| `MUSEO_API_BASE_URL` | string | `http://127.0.0.1:5000` | Base URL of the main Flask application, as seen from the TTS sidecar. Used in the TTS service when it needs to call back to the Flask API. |
