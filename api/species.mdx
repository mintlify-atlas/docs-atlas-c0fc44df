---
title: "Species Public API Endpoints in BioScan Museo"
sidebarTitle: "Species Pages"
description: "Public HTML routes for the species catalogue: browse, search, view detail pages, scan QR codes, and compare two related species side-by-side."
---
