---
title: "BioScan Museo Admin: Scan Metrics and Audit Log Endpoints"
sidebarTitle: "Metrics"
description: "Admin-only JSON endpoints for scan metrics and species audit history. Filter by date range, species, scan origin, or action type. Requires admin."
---
