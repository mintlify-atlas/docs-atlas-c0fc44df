---
title: "BioScan Museo TTS WebSocket API: QR Detection Stream"
...
| `1000` | _(no message after `qr_found`)_ | — | Server closes cleanly after the first successful QR detection |
