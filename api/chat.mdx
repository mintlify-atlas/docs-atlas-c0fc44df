---
title: "BioScan Museo: RAG-Powered Chat Endpoints for Species"
sidebarTitle: "Chat"
description: "Send questions to the RAG museum guide via POST /api/chat (anonymous JSON) or POST /api/chat_stream (authenticated streaming with tour memory)."
---
